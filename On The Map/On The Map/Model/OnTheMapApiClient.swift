...
class OnTheMapApiClient {
    ...
    class func postStudentLocation(addStudentInformationRequest: AddStudentInformationRequest, callback: @escaping (_ objectId: String?, _ error: String?) -> Void) {
    ...
    class func getStudentLocations(callback: @escaping (_ studentLocations: [StudentInformation]?, _ error: String?) -> Void) {
